...
const TIPS: Record<Locale, Record<string, TipCopy>> = {
  ...
  ru: {
    Kask: { title: "Шлем", text: "Полный или открытый шлем обязателен; ночью — светоотражающая одежда." },
    "Kask zorunlu": { title: "Шлем обязателен", text: "Тайская полиция проверяет шлемы; принимают полный или открытый." },
    Yağmur: { title: "Дождь", text: "Возьмите дождевик и водонепроницаемую сумку для тропических ливней." },
    Yakıt: { title: "Топливо", text: "Держите полный бак на длинных маршрутах; в горах АЗС редки." },
    "Uzun yol": { title: "Дальняя поездка", text: "Отдыхайте каждые 2 часа; не ездите уставшим." },
    Muson: { title: "Муссон", text: "Сбавьте скорость на горных дорогах в дождь; увеличьте дистанцию торможения." },
    GPS: { title: "GPS", text: "Скачайте офлайн-карты для многодневных туров; связь может пропасть." },
    "Derin güney": { title: "Глубокий юг", text: "Проверьте рекомендации для Satun и Hat Yai; избегайте ночной езды." },
    İletişim: { title: "Связь", text: "В удалённых районах слабый сигнал; сохраните офлайн-карты и экстренные номера." },
    Konaklama: { title: "Проживание", text: "Заранее уточните парковку для скутера в отеле." },
    "Güneş & su": { title: "Солнце и вода", text: "SPF 50+ и минимум 2 л воды; отдых в тени 11:00–15:00." },
    Farlar: { title: "Свет", text: "Ночью используйте дальний свет где безопасно; сбавляйте в поворотах." },
    Alkol: { title: "Алкоголь", text: "Не садитесь на байк после алкоголя; используйте Grab или такси." },
    "Bangla & Patong": { title: "Bangla и Patong", text: "Паркуйтесь безопасно в людных местах; не оставляйте вещи на виду." },
    Deniz: { title: "Море", text: "Не купайтесь при красном флаге; в муссон течения сильные." },
    Işık: { title: "Свет", text: "После заката быстро темнеет; носите светлую или светоотражающую одежду." },
    "Tapınak kıyafeti": { title: "Одежда для храма", text: "Скромная одежда в Wat Chalong и Big Buddha." },
    "Çocuk güvenliği": { title: "Безопасность детей", text: "Детский шлем и панама; возьмите дополнительную воду." },
    Güvenlik: { title: "Безопасность", text: "Не подходите к ограждению ВПП; останавливайтесь только в разрешённых зонах." },
  },
};
...
const YAKIT_DAY: Partial<Record<Locale, TipCopy>> = {
  ...
  ru: { title: "Топливо", text: "Заправьтесь перед выездом из Patong; на южных маршрутах АЗС в Rawai/Chalong." },
};
...
const KASK_IDP: Partial<Record<Locale, TipCopy>> = {
  ...
  ru: { title: "Шлем", text: "Полный шлем и действующий IDP обязательны." },
};
...
const GPS_VILLAGE: Partial<Record<Locale, TipCopy>> = {
  ...
  ru: { title: "GPS", text: "Используйте офлайн-карты на деревенских дорогах." },
};
